...
Every project should have a written plan or PRD (e.g., `docs/prd.md`, `docs/plan.md`, or `docs/tasks.md`). Convert the plan into an explicit checklist of to-dos and work through it incrementally.
Best practices.
