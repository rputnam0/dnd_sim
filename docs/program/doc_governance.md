...
| `docs/program/parity_leaf_registry.csv` | canonical | program-control | not_applicable | Exact record-to-leaf ownership map used during strict parity closeout. |
| `docs/program/parity_batch_registry.csv` | canonical | program-control | not_applicable | Exact record-to-batch execution map used during strict parity closeout. |
...
- `docs/program/parity_leaf_registry.csv` is the exact blocker-to-leaf ownership map used during strict parity closeout.
- `docs/program/parity_batch_registry.csv` is the exact blocker-to-batch execution map used during strict parity closeout.
