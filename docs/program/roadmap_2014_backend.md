...
- FIN-06 is in PR review on `codex/feat/fin-06-cut-release-baseline-archive-prior-program-artifac` ([#153](https://github.com/rputnam0/dnd_sim/pull/153)) after `FIN-02`, `FIN-03`, `FIN-04`, and `FIN-05` dependency clearance.
