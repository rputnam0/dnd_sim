...
- WLD-09 is in progress on `codex/feat/wld-09-build-multi-encounter-adventuring-day-persistence` with campaign runtime persistence and deterministic short/long-rest recovery coverage in `tests/test_adventuring_day_flow.py`.
