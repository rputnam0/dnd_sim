...
| W6-PAR-05G1D | codex/feat/w6-par-05g1d-survival-recovery-support | remediation_parity | in_progress | Fresh continuation lane for the survival/recovery G1 cluster (`chalice` through `vitality_of_the_tree`) while parallel G1A/G1B/G1C ownership remains isolated. |
