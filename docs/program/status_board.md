...
| OBS | Replay, Logging, and Observability | pr_open | 5D-observability | `OBS-02`, `OBS-03`, and `OBS-05` are `pr_open` in `backlog.csv`; remaining OBS tasks are `not_started`. |
...
- No active DOC blockers remain; OBS telemetry work is active in PR review.
