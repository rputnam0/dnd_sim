...
- [ ] AI-03 Implement concentration breaking, control value, and disable value scoring (in progress on `codex/feat/ai-03-implement-concentration-breaking-control-value-and`)
