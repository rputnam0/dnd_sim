...
def test_w6_par_05d1_species_records_are_non_executable_in_feature_manifest() -> None:
...
def test_w6_par_05d1_species_records_are_non_executable_in_canonical_records() -> None:
